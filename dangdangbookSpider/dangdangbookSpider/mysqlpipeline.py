...
class MysqlPipeline(object):
    ...
    def process_item(self, item, spider):
        ...
        self.cursor.execute('insert into book_info(book_id,book_name,imgurl,detail,price,author,category_id)VALUES ("{}","{}","{}","{}","{}","{}","{}")'
                            .format(item['book_id'],item['book_name'], item['imgUrl'],item['detail'],item['price'],item['author'],item['category_id']))
        self.conn.commit()
